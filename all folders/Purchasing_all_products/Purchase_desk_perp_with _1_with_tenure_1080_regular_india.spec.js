...
import { addWalletBalance } from '../utils/Add_Ac_to_wallet_via_UI_if_insufficient_balance_error_comes.spec';

//purchase 1 desk perp basic single user with tenure=1080, region=india, category=regular
...
//   await page.getByRole('combobox').nth(2).selectOption('GST Practitioner');
//   await page.getByRole('combobox').nth(2).selectOption('Accountant');
//   await page.getByRole('combobox').nth(2).selectOption('FOC');
// });
// --------------------------------------------
...
test('test', async ({ page }) => {
  ...
  //==============you can purchase foc as well with tenure 360 or 1080 tenure===============
  //   await page.getByRole('combobox').nth(2).selectOption('GST Practitioner');
//   await page.getByRole('combobox').nth(2).selectOption('Accountant');
//   await page.getByRole('combobox').nth(2).selectOption('FOC');
//============================================================================================
